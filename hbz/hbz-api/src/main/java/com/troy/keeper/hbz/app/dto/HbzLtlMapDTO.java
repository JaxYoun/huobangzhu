...
public class HbzLtlMapDTO {
    ...
    @ValueFormat(validations = {
            @Validation(use = "ltl_order_create", format = ValidConstants.NULL, msg = "{fieldName}不能自己设置"),
            @Validation(use = "ltl_order_confirm", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_create", format = ValidConstants.NULL, msg = "{fieldName}不能自己设置"),
            @Validation(use = "web_ltl_order_update", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空")
    })
    private Long id;
    ...
    @ValueFormat(validations = {
            @Validation(use = "ltl_order_create", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_create", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_update", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空")
    })
    ...
    @ValueFormat(validations = {@Validation(use = "web_ltl_order_update", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_create", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空")
    })
    ...
    @QueryColumn
    @ValueFormat(validations = {@Validation(use = "ltl_order_create", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_create", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_update", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空")
    })
    ...
    @ValueFormat(validations = {@Validation(use = "ltl_order_create", format = ValidConstants.REGEX, msg = "{fieldName}不能为空", conf = "\\d{4}\\-\\d{2}\\-\\d{2}\\s\\d{2}\\:\\d{2}"),
            @Validation(use = "web_ltl_order_create", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空"),
            @Validation(use = "web_ltl_order_update", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空")
    })
    ...
    @ValueFormat(validations = {
            @Validation(use = "ltl_order_create", format = ValidConstants.NOT_NULL, msg = "预估价格[{fieldName}]为空")
    })
    ...
    //用户状态信息
//@ValueFormat(validations = {@Validation(use = "ltl_near_search_task",format = ValidConstants.NOT_NULL,msg="{fieldName}不能为空")})
