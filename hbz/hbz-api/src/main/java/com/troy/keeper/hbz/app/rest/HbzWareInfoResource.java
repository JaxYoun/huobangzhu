...
import com.troy.keeper.hbz.app.dto.HbzWareInfoMapDTO;
...
public class HbzWareInfoResource {
    ...
    public ResponseDTO query(@RequestBody HbzWareInfoMapDTO wareInfoMapDTO) {
        ...
        List<String> columns = BeanHelper.getFieldsByIncExcludeAt(HbzWareInfo.class, new Class[]{Id.class, Column.class, ManyToOne.class, ManyToMany.class, OneToMany.class}, new Class[]{Lob.class});
        List<HbzWareInfoDTO> list = entityService.query(HbzWareInfo.class, mapper, wareInfoDTO, columns);
    ...
    public ResponseDTO queryPage(@RequestBody HbzWareInfoMapDTO wareInfoMapDTO) {
        ...
        wareInfoDTO.setStatus("1");
        List<String> columns = BeanHelper.getFieldsByIncExcludeAt(HbzWareInfo.class, new Class[]{Id.class, Column.class, ManyToOne.class, ManyToMany.class, OneToMany.class}, new Class[]{Lob.class});
        Page<HbzWareInfoDTO> page = entityService.queryPage(HbzWareInfo.class, mapper, wareInfoDTO.getPageRequest(), wareInfoDTO, columns);
