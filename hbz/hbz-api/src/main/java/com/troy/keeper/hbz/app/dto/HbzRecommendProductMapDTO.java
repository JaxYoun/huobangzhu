...
public class HbzRecommendProductMapDTO extends HbzBaseMapDTO {
    ...
    @ValueFormat(validations = {
            @Validation(use = "recommend_product_d", format = ValidConstants.NOT_NULL, msg = "不能为空"),
            @Validation(use = "recommend_product_att", format = ValidConstants.NOT_NULL, msg = "不能为空"),
            @Validation(use = "recommend_product_upd", format = ValidConstants.NOT_NULL, msg = "不能为空")
    })
    private Long id;
    ...
    @ValueFormat(validations = {
            @Validation(use = "recommend_product_upd", format = ValidConstants.NOT_NULL, msg = "商品id{fieldName}不能为空"),
            @Validation(use = "recommend_product_cr", format = ValidConstants.NOT_NULL, msg = "商品id{fieldName}不能为空")
    })
    Long productId;
