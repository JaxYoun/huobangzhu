 ...
 */
@Component
public class HbzOrderMapper extends BaseMapper<HbzOrder, HbzOrderDTO> {
    ...
    @Override
    public HbzOrder newEntity() {
        return new HbzOrder();
    }

    @Override
    public HbzOrderDTO newDTO() {
        return new HbzOrderDTO();
    }

    @Override
    public HbzOrder find(Long id) {
        return hbzOrderRepository.findOne(id);
    }

    @Override
    public void entity2dto(HbzOrder entity, HbzOrderDTO dto) {
    ...
    @Override
    public void dto2entity(HbzOrderDTO dto, HbzOrder entity) {
        BeanUtils.copyProperties(dto, entity, StringHelper.conact(Const.ID_AUDIT_FIELDS, "createUser", "takeUser", "agent", "dealUser", "originArea", "destArea"));
