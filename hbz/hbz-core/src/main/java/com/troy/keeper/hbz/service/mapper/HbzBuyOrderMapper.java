 ...
 */
@Component
public class HbzBuyOrderMapper extends BaseMapper<HbzBuyOrder, HbzBuyOrderDTO> {
    ...
    @Override
    public HbzBuyOrder newEntity() {
        return new HbzBuyOrder();
    }

    @Override
    public HbzBuyOrderDTO newDTO() {
        return new HbzBuyOrderDTO();
    }

    @Override
    public HbzBuyOrder find(Long id) {
        return hbzBuyOrderRepository.findOne(id);
    }

    @Override
    public void entity2dto(HbzBuyOrder entity, HbzBuyOrderDTO dto) {
    ...
    @Override
    public void dto2entity(HbzBuyOrderDTO dto, HbzBuyOrder entity) {
