 ...
 */
@Component
public class HbzLtlOrderMapper extends BaseMapper<HbzLtlOrder, HbzLtlOrderDTO> {
    ...
    @Override
    public HbzLtlOrder newEntity() {
        return new HbzLtlOrder();
    }

    @Override
    public HbzLtlOrderDTO newDTO() {
        return new HbzLtlOrderDTO();
    }

    @Override
    public HbzLtlOrder find(Long id) {
        return hbzLtlOrderRepository.findOne(id);
    }

    @Override
    public void entity2dto(HbzLtlOrder entity, HbzLtlOrderDTO dto) {
    ...
    @Override
    public void dto2entity(HbzLtlOrderDTO dto, HbzLtlOrder entity) {
