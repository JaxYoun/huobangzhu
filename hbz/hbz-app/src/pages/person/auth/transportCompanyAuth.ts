...
@Component({
  selector: 'transportCompanyAuth',
  templateUrl: 'transportCompanyAuth.html'
})
export class TransportCompanyAuth {

    private enterpriseAdminUrl: string = "/api/user/app/registry/transEnterprise/submit";//货运企业资质提交
    ...
    constructor(
        ...
        public config:Config) {
          ...
          this.enterpriseAdminUrl = this.helperService.api + this.enterpriseAdminUrl;
          ...
          this.businessLicense = this.defaultPhoto;
            ...
            this.http.post(this.searchUrl,{registryCode:'TransEnterprise'},this.helperService.getOptions())
            .subscribe((data)=> {
    ...
    submitUpload(){
      ...
      this.http.post(this.enterpriseAdminUrl,
