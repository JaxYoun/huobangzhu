...
@Component({
  selector: 'personShipperAuth',
  templateUrl: 'personShipperAuth.html'
})
export class PersonShipperAuth {
    private consignorUrl: string = "/api/user/app/registry/personConsignor/submit";//个人货主资质提交
    private searchUrl: string = "/api/user/app/registry/search";//资质查询
    public title:string = '个人货主';
    ...
    constructor(
        ...
        public config:Config) {
          ...
          this.consignorUrl = this.helperService.api + this.consignorUrl;
          ...
          this.certifiedPhoto = this.defaultPhoto;
            ...
            this.http.post(this.searchUrl,{registryCode:'PersonConsignor'},this.helperService.getOptions())
            .subscribe((data)=> {
    ...
    submitUpload(){
      ...
      this.http.post(this.consignorUrl,
