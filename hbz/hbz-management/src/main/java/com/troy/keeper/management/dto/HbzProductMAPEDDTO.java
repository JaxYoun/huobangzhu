...
public class HbzProductMAPEDDTO extends HbzBaseMapDTO {
    ...
    @ValueFormat(validations = {
            @Validation(use = "product_cr", format = ValidConstants.NOT_NULL, msg = "商品备注{fieldName}不能为空")
    })
    private String message;

    @ValueFormat(validations = {
            @Validation(use = "product_cr", format = ValidConstants.NOT_NULL, msg = "商品产地{fieldName}不能为空")
    })
