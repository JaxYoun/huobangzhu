...
@Data
@Setter
public class HbzDeliveryBoyRegistryMapDTO {

    @ValueFormat(validations = {@Validation(use = "delivery_boy_registry", format = ValidConstants.NULL, msg = "注册时不能指定具体id")})
    private Long id;
    ...
    //证件照片Base64编码
    @ValueFormat(validations = {@Validation(use = "delivery_boy_registry", format = ValidConstants.NOT_NULL, msg = "{fieldName}不能为空")})
